//
//  SoftwareListCollectionViewCell.swift
//  w3-hw3
//
...
class SoftwareListCollectionViewCell: UICollectionViewCell {
    //MARK: - UI
    ...
    func saveCell(data: Search) {
        if let name = data.trackName, let image = data.artworkUrl600 ?? data.artworkUrl100  {
