//
//  PodcastListCollectionViewCell.swift
//  w3-hw3
//
...
class PodcastListCollectionViewCell: UICollectionViewCell {
    ...
    func saveCell(data: Search) {
        if let name = data.trackName, let price = data.trackPrice, let image = data.artworkUrl600 {
