//
//  EbookListCollectionViewCell.swift
//  w3-hw3
//
...
class EbookListCollectionViewCell: UICollectionViewCell {
    ...
    private func configureConstraints() {
        NSLayoutConstraint.activate([
            ...
            searchImage.heightAnchor.constraint(equalToConstant: contentView.frame.size.height / 1.8),
    ...
    func saveCell(data: Search) {
        if let name = data.trackName, let price = data.formattedPrice, let image = data.artworkUrl600 ?? data.artworkUrl100  {
